...
export const Icon2 = ({ className }: Props): JSX.Element => {
  return (
    ...
    >
      <path
        className="path"
        d="M13.3333 4.16666L19.1667 9.99999L13.3333 15.8333"
        stroke="url(#paint0_linear_1_2386)"
        strokeLinecap="round"
      ...
      <path
        ...
        stroke="url(#paint1_linear_1_2386)"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeMiterlimit="10"
        strokeWidth="1.5"
