...
import { ChevronLeft, ChevronRight, ZoomIn, ZoomOut, RotateCcw, Timer, Flag, BookOpen } from 'lucide-react';
...
const TestViewer = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 flex flex-col overflow-hidden">
      <PageLogo />
      {/* Background Effects */}
      ...
      <header className="relative z-10 backdrop-blur-md bg-white/5 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <SATurnLogo />
          <div className="flex items-center space-x-2 backdrop-blur-md bg-white/10 px-4 py-2 rounded-lg
      ...
      <div className="flex flex-1 overflow-hidden relative z-10">
        ...
        <div className="w-64 backdrop-blur-md bg-white/5 border-r border-white/10 p-4
          ...
          <div className="flex-1 overflow-auto bg-slate-950/50 p-4 relative flex flex-col gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md shadow-lg rounded-lg overflow-hidden
              ...
              <div className="flex items-center mb-4">
                <span className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-500/20 border border-yellow-500/30 text-white">
                  {difficulty}
                </span>
              </div>
              <div className="text-white/90">
